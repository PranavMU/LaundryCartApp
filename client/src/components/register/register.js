        ...
        <section className="right-register-container">
            ...
            <form>
                <div className="register-name-input-section">
                    <input id="name1" type="text" placeholder="Name" className="register-name-input-section-name"/>
                <hr className="hr3"></hr>
                </div>
                 <div className="register-email-input-section">
                    <input id="email1" type="email1" placeholder="Email" className="register-email-input-section-email"/>
                    <hr className="hr4"></hr>   
                </div>
                <div className="register-phone-input-section">
                    <input id="phone1" type="text" placeholder="Phone" className="register-phone-input-section-section-phone"/>
                    <hr className="hr5"></hr>   
                </div>
                <div className="register-state-input-section">
                    <input id="state" type="text" placeholder="State" className="register-state-input-section-state"/>
                    <hr className="hr6"></hr>   
                </div>
                <div className="register-district-input-section">
                    <input id="district" type="text" placeholder="District" className="register-state-input-section-district"/>
                    <hr className="hr7"></hr>   
                </div>
                <div className="register-address-input-section">
                    <input id="address" type="text" placeholder="Address" className="register-address-input-section-address"/>
                    <hr className="hr8"></hr>   
                    </div>
                <div className="register-pincode-input-section">
                    <input id="pincode" type="text" placeholder="Pincode" className="register-pincode-input-section-pincode"/>
                    <hr className="hr9"></hr>   
                </div>
